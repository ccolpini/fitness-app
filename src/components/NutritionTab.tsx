  ...
  return (
    <div className="pb-4">
      ...
      <div className="relative overflow-hidden px-4 pt-6 pb-4"
        style={{ background: 'radial-gradient(ellipse at top left, #0a1a10 0%, #0A0A0A 60%)' }}>
        <div className="absolute inset-0 opacity-30"
          style={{ background: `radial-gradient(ellipse at top center, ${cfg.color}25, transparent 60%)` }} />
        <div className="relative">
          <h1 className="text-white leading-none mb-1" style={{ fontSize: '36px', fontWeight: 800 }}>NUTRITION</h1>
          <p style={{ fontSize: '14px', color: '#666' }}>Fuel your recomposition</p>
        </div>
      </div>

      <div className="px-4">
        {/* Mode Toggle — pill style */}
        <div className="flex gap-1.5 p-1 rounded-2xl mb-5" style={{ backgroundColor: '#1E1E1E' }}>
        ...
        {/* Macro Bars */}
        <div className="rounded-xl p-4 mb-4" style={{ background: '#141414', border: '1px solid rgba(255,255,255,0.06)', boxShadow: '0 2px 12px rgba(0,0,0,0.4)' }}>
              ...
              <div key={m.label}>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-[10px]" style={{ color: '#666' }}>{m.unit}</span>
                  </div>
                </div>
        ...
        {(currentWeek === 6 || nutritionMode === 'dietBreak') && (
          <div className="relative overflow-hidden rounded-xl p-4 mb-4 animate-scale-in"
            style={{ background: '#141414', border: '1px solid rgba(255,184,0,0.2)', boxShadow: '0 2px 12px rgba(0,0,0,0.4)' }}>
        ...
        {(currentWeek === 9 || nutritionMode === 'deload') && (
          <div className="relative overflow-hidden rounded-xl p-4 mb-4 animate-scale-in"
            style={{ background: '#141414', border: '1px solid rgba(168,85,247,0.2)', boxShadow: '0 2px 12px rgba(0,0,0,0.4)' }}>
            ...
            <div key={i} className="relative overflow-hidden rounded-xl p-4 mb-2"
              ...
              <div className="flex items-start justify-between mb-2 pl-2">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] rounded-full px-2 py-0.5" style={{ color: '#666', backgroundColor: '#1E1E1E' }}>{meal.time}</span>
                  </div>
              ...
              <div className="pl-2">
                {meal.foods.map((food, j) => (
                  <p key={j} className="text-[11px] leading-relaxed" style={{ color: '#666' }}>
